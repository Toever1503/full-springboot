...
@Setter
@NoArgsConstructor
//@NamedStoredProcedureQuery(name = "findOrderAndPriceByTimeAndStatus", procedureName = "order_by_status_and_time", resultClasses = OrderByStatusAndTimeDto.class, parameters = {
//        @StoredProcedureParameter(name = "status_order", mode = ParameterMode.IN, type = String.class),
//        @StoredProcedureParameter(name = "time_from", mode = ParameterMode.IN, type = String.class),
//        @StoredProcedureParameter(name = "time_to", mode = ParameterMode.IN, type = String.class),
