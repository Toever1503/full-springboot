...
public interface INotificationRepository extends JpaRepository<NotificationEntity, Long>, JpaSpecificationExecutor<NotificationEntity> {
   ...
   @Transactional(rollbackFor = RuntimeException.class)
    ...
    @Query("select new com.dtos.NotificationDto(n.id, n.image, n.title, n.status, n.contentExcerpt, n.updatedDate , n.createdDate, n.isEdit, u.userName, n.viewed ,nu.isRead, n.attachFiles)" +
