...
public class UserResources {
    ...
    public ResponseEntity loginUser(@RequestBody @Valid JwtUserLoginModel model) {
        ...
        return jwtUserLoginModel == null ? new ResponseEntity<>("Sai mật khẩu", HttpStatus.BAD_REQUEST) : new ResponseEntity<>(ResponseDto.of(jwtUserLoginModel, "login"), HttpStatus.OK);
    }
